...
goog.provide('mozgas.util');
goog.require('cljs.core');
goog.require('clojure.string');
mozgas.util.dash_to_camel = (function mozgas$util$dash_to_camel(dashed){
...
mozgas.util.camelcase_map = (function mozgas$util$camelcase_map(m){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__7320__auto__ = (function mozgas$util$camelcase_map_$_iter__12922(s__12923){
...
cljs.core.chunk_append(b__12925,((cljs.core.map_QMARK_(v))?cljs.core.PersistentArrayMap.fromArray([mozgas.util.dash_to_camel(k),mozgas$util$camelcase_map(v)], true, false):cljs.core.PersistentArrayMap.fromArray([mozgas.util.dash_to_camel(k),v], true, false)));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12925),mozgas$util$camelcase_map_$_iter__12922(cljs.core.chunk_rest(s__12923__$2)));
} else {
...
return cljs.core.cons(((cljs.core.map_QMARK_(v))?cljs.core.PersistentArrayMap.fromArray([mozgas.util.dash_to_camel(k),mozgas$util$camelcase_map(v)], true, false):cljs.core.PersistentArrayMap.fromArray([mozgas.util.dash_to_camel(k),v], true, false)),mozgas$util$camelcase_map_$_iter__12922(cljs.core.rest(s__12923__$2)));
}
} else {
return null;
}
...
mozgas.util.throw_err = (function mozgas$util$throw_err(var_args){
